...
| [`shell_host/model.rs`](../../../../../crates/cosh-shell/src/shell_host/model.rs) | `ShellHostConfig` defaults to native mode and can disable AI classification | Direct local shell remains an explicit compatibility boundary |
