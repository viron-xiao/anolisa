...
const enUSMessages = {
  ...
  'risk.form.bindingLimitWarning': 'The current enforcement backend supports at most {maxActiveBindings} active policies; please detach existing policies before issuing new ones.',
  ...
  'audit.description': 'Starting from Agent sessions, correlate tool calls, processes, files, network activity and policy decisions to form a traceable evidence chain.',
...
export const messages: Record<Locale, Record<MessageKey, string>> = {
  ...
  'zh-CN': {
    ...
    'risk.form.bindingLimitWarning': '当前策略执行能力最多支持 {maxActiveBindings} 条生效策略；请先解除现有策略后再下发。',
    ...
    'audit.description': '从 Agent 会话出发，关联工具调用、进程、文件、网络和策略判定，形成可追溯证据链。',
